...
{:else}
    <div class="flex flex-col gap-36 lg:gap-48 xl:gap-56">
        ...
        <section class="flex justify-between gap-8 lg:gap-16 xl:gap-24 mt-8 md:mt-12 lg:mt-14 xl:mt-16">
            <div class="flex flex-col justify-center gap-6 lg:gap-8 xl:gap-10">
                <div class="flex flex-col gap-4 lg:gap-5 xl:gap-6">
                    <h1 style="line-height: 1.1;" class="font-bold text-4xl lg:text-5xl xl:text-6xl max-w-lg xl:max-w-2xl">
                    ...
                    <h3 class="max-w-sm xl:max-w-lg text-xs lg:text-sm xl:text-base">
                        We hate reading boring articles just to understand what's happening around us, that's why we created WPTAT
                    </h3>
                </div>
                <div class="flex gap-4 lg:gap-5 xl:gap-6">
                    <button 
                    class="w-40 lg:w-48 xl:w-52 py-2.5 h-10 lg:h-11 xl:h-12 min-h-0 text-xs lg:text-sm rounded-md bg-primary-gradient font-semibold text-white hover:brightness-105 focus:hover:brightness-105 btn shadow-md hover:shadow-lg">
                        TRY OUR SCREENER
                    </button>
                    <div class="relative">
                        <button on:click={toggleDropdown} class="w-40 lg:w-48 xl:w-52 h-10 lg:h-11 xl:h-12 min-h-0 shadow-md hover:shadow-lg text-xs lg:text-sm rounded-md border lg:border-2 border-neutral text-neutral hover:border-neutral-dark hover:text-neutral-dark btn font-light">
                            ...
                            <div transition:fade={{duration: 300}} class="flex flex-col h-12 lg:h-13 justify-between">
                                <div class="flex justify-center gap-1 lg:gap-2.5 xl:gap-3">
                                    {#each ['🤬', '🤢', '😨', '😐', '😭', '😲', '😀'] as emotion_item, index}
                                        ...
                                        class="py-1 px-1.5 lg:px-2 lg:py-1.5 xl:py-1 text-xs lg:text-sm rounded-md flex flex-col justify-center border border-white"
        ...
        <section class="flex flex-col">
            <div class="text-center flex flex-col gap-4 lg:gap-7 xl:gap-8">
                <h2 class="font-medium text-3xl lg:text-4xl">What People Think About</h2>
            ...
            <div class="flex flex-col gap-2 lg:gap-4 mt-9 lg:mt-12 xl:mt-14">
                <div class="flex justify-center">
                    <div class="relative">
                        <button on:click={toggleSmallDropdown} class="w-40 lg:w-48 xl:w-52 text-xs lg:text-sm h-8 xl:h-9 min-h-0 shadow-md hover:shadow-lg rounded-md border lg:border-2 border-neutral text-neutral hover:border-neutral-dark hover:text-neutral-dark btn font-light">
                            Change Analysis
                        </button>
