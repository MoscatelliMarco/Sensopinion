<script>
    ...
    $: if (parameters) {
        news_article_show = news.filter((item) => {
            if (parameters['category'] == 'politics' || parameters['category'] == 'economy' || parameters['category'] == 'environment') {
                if (Object.keys(item['categories']).includes(parameters['category'])) {
                    return true
                }
            } else {
            ...
            <div class="flex gap-2">
                <div class="flex flex-col justify-center">
                    <h2 class="text-2xl font-medium">
                        <svg class="w-8 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" version="1.1">
                        ...
                        {news_article_show[0] ? news_article_show[0]['title'].slice(0, 100).replace(/\s$/, '') : ""}{news_article_show[0] ? news_article_show[0]['title'].length > 100 ? "..." : "" : ""}</h2>
                </div>
            </div>
    ...
    <div class="flex flex-col gap-4 mb-4 justify-center">
        ...
        <div class="flex w-full gap-4">
            ...
            <div class="flex flex-col justify-center gap-1">
                ...
                <p class="text-sm font-light">{news_article_show[1] ? news_article_show[1]['description'].slice(0, 200).replace(/\s$/, '') : ""}{news_article_show[1] ? news_article_show[1]['description'].length > 200 ? "..." : "" : ""}</p>
            </div>
        </div>
        ...
        <div class="flex w-full gap-4">
            ...
            <div class="flex flex-col justify-center gap-1">
                ...
                <p class="text-sm font-light">{news_article_show[2] ? news_article_show[2]['description'].slice(0, 200).replace(/\s$/, '') : ""}{news_article_show[2] ? news_article_show[2]['description'].length > 200 ? "..." : "" : ""}</p>
            </div>
        </div>
